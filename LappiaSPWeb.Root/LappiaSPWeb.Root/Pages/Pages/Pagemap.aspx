...
<%@ Register TagPrefix="Pagemap" Namespace="LappiaSPWeb.Root.Webparts.Pagemap" Assembly="LappiaSPWeb.Root, Version=1.0.0.0, Culture=neutral, PublicKeyToken=969e4a4c61829e02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <WebPartPages:WebPartZone runat="server" Title="MainContent" ID="WebPartZone1" PartChromeType="None">
        <ZoneTemplate>
            <Pagemap:Pagemap ID="Pagemap" runat="server" ChromeType="None" />
        </ZoneTemplate>
