...
{
    public class LappiaArticlePageLayout : Microsoft.SharePoint.Publishing.PublishingLayoutPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    LappiaUtility.LappiaUtility.AddErrorLog(SPContext.Current.Web.Url, "LappiaArticlePageLayout -  Page_Load", Convert.ToString(ex), LappiaUtility.LappiaUtility.ErrorSeverity.High);
                }
            }
        }
    }
