<%--<%@ Page Language="C#" Inherits="Microsoft.SharePoint.Publishing.PublishingLayoutPage,Microsoft.SharePoint.Publishing,Version=15.0.0.0,Culture=neutral,PublicKeyToken=71e9bce111e9429c" MasterPageFile="/sites/en-US/_catalogs/masterpage/LappiaMasterPage.master" %>--%>

<%@ Page Language="C#" Inherits="LappiaSPWeb.Root.PageLayouts.LappiaInnerPageLayout, $SharePoint.Project.AssemblyFullName$" MasterPageFile="../../_catalogs/masterpage/LappiaMasterPage.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <section id="content" class="inner_area">
        ...
        <div class="wthfix">
            ...
            <%--<ol class="breadcrumb">
               <asp:SiteMapPath ID="Sitemappath1" runat="server" sitemapproviders="SPSiteMapProvider,SPContentMapProvider" RenderCurrentNodeAsLink="false" hideinteriorrootnodes="true"></asp:SiteMapPath>
            </ol>--%>
            <div class="leftside">
...
<%--<footer id="footer">
    ...
    <div class="sociallink">
      <div class="social">
        <div class="col5"><a href="#" title="facebook" class="sl facebook"></a></div>
        <div class="col5"><a href="#" title="twitter" class="sl twitter"></a></div>
        <div class="col5"><a href="#" title="instagram" class="sl instagram"></a></div>
        <div class="col5"><a href="#" title="youtube" class="sl youtube"></a></div>
        <div class="col5"><a href="#" title="ask" class="sl ask"></a></div>
      </div>
    </div>
