(function ($) {
    ...
    var services = {
        ...
        facebook: {
            url: 'https://www.facebook.com/sharer/sharer.php?u={url}&title={title}&display=popup&ref=plugin',
            supportCount: true,
        ...
        linkedin: {
            url: 'http://www.linkedin.com/shareArticle?url={url}&title={title}&summary={url}',
            supportCount: true,
            screenSize: { height: 650, width: 1024 }
        },
        pinterest: {
    ...
    function getStats(serviceName, url, callback) {
        ...
        //    myurl = 'https://graph.facebook.com/?id=' + encodeURIComponent(url);
        //}
        //else if (serviceName == "googleplus") {
        //    myurl = slash($.fn.sharegg.defaults.apiUrl) + 'stats/' + serviceName + '?url=' + encodeURIComponent(url);
        //}
        //else if (serviceName == "twitter") {
        //    myurl = 'https://cdn.api.twitter.com/1/urls/count.json?url=' + encodeURIComponent(url);
        //}
        //if (serviceName == "linkedin") {
        //    myurl = 'https://www.linkedin.com/countserv/count/share?url=' + encodeURIComponent(url) + '&format=json';
        //}
        $.ajax({
            //url: myurl,//slash($.fn.sharegg.defaults.apiUrl) + 'stats/' + serviceName + '?url=' + encodeURIComponent(url),
